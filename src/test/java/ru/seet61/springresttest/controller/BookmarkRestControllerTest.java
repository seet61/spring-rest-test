...
import ru.seet61.springresttest.SpringRestTestApplication;
...
@SpringBootTest(classes = SpringRestTestApplication.class)
@WebAppConfiguration
public class BookmarkRestControllerTest {
    ...
    public void userNotFound() throws Exception {
        this.mockMvc.perform(post("/bookmarks/george")
    ...
    public void readSingleBookmark() throws Exception {
        this.mockMvc.perform(get("/bookmarks/" + this.userName + "/" + this.bookmarkList.get(0).getId()))
